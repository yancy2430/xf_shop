        ...
        <ul v-if="shopLists.length !=0">
            ...
            <li v-for="(item,index) in shopLists" :key="index">
                <div @click="paymentIn(item)">
                    <div class="title">
                        <div class="titleText">待发货</div>
                        <!--<div class="times">-->
                            <!--<img src="/static/images/time.png" alt="" class="img">-->
                            <!--<span class="time">剩00小时15分钟00秒</span>-->
                        <!--</div>-->
                        {{item.id}}
                    </div>
                    <div class="imgTitle">
                ...
                <div class="buts">
                    <!--<span class="at-once" @click="paymentIn">立即付款</span>-->
...
<script>
    export default {
        ...
        computed:{
            ...
            //orderAmount
            orderAmount(){
                return this.shopLists.totalprice + this.shopLists.freight - this.shopLists.integralResist
            }
        },
        methods:{
            // 查看详情
